...
$cleanliness_review = $_POST['cleanliness_review'];
...
if(trim($name_review) == '') {
	...
	exit();
} else if(trim($cleanliness_review ) == '') {
	echo '<div class="error_message">Please rate Cleanliness.</div>';
	exit();
...
$e_subject = 'Citytours Hotel Review';

// You can change this if you feel that you need to.
$e_body = "You have been contacted by $name_review $lastname_review with the following $hotel_name review:" . PHP_EOL . PHP_EOL;
$e_content = "Room type: $room_type_review.\nCleanliness rate: $cleanliness_review.\nComfort rate: $comfort_review.\nRoom price rate: $price_review.\nQuality rate: $quality_review.\n\nReview: $review_text" . PHP_EOL . PHP_EOL;
...
$usermessage = "Thank you for review $hotel_name! Here a summary of your review: \n $e_content. ";
