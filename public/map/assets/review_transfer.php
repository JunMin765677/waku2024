...
$kindness_review = $_POST['kindness_review'];
...
if(trim($name_review) == '') {
	...
	echo '<div class="error_message">Please rate Service price.</div>';
	exit();
} else if(trim($kindness_review ) == '') {
	echo '<div class="error_message">Please rate Kindness.</div>';
	exit();
...
$e_subject = 'Citytours Transfer Review';

// You can change this if you feel that you need to.
$e_body = "You have been contacted by $name_review $lastname_review with the following $transfer_name review:" . PHP_EOL . PHP_EOL;
$e_content = "Comfort rate: $comfort_review.\nPunctuality rate: $punctuality_review.\nService price rate: $price_review.\nKindness rate: $kindness_review.\n\nReview: $review_text" . PHP_EOL . PHP_EOL;
...
$usermessage = "Thank you for review $transfer_name ! Here a summary of your review: \n $e_content. ";
